package id.ac.umn.week11_38083;
        ...
        postServices.getPosts().enqueue(new Callback<List<PostModel>>() {
            ...
            public void onResponse(Call<List<PostModel>> call, Response<List<PostModel>> response) {
                if(response.isSuccessful()) {
                    ...
                    Log.d("MainActivity", "Received responses: " + String.valueOf(data.size()));
                    ...
                    Toast.makeText(getApplicationContext(), "Failed to get posts. Unknown" +
                            "API error", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<List<PostModel>> call, Throwable t) {
                ...
                Toast.makeText(getApplicationContext(), "Failed to get posts. Check " +
